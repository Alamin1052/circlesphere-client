    ...
    return (
        <div className="drawer lg:drawer-open max-w-7xl mx-auto ">
            ...
            <div className="drawer-content">
                {/* Navbar */}
                <nav className="navbar w-full flex justify-between bg-base-300">
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-300 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-ful grow">
                        ...
                        <li>
                            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Events" to="/dashboard/my-events">
                                <MdEvent />
